...
abstract class Fullscreen {
  ...
  /// Whether a working fullscreen toggle is available here. True on web browsers
  /// with a functioning Fullscreen API (desktop, Android Chrome). FALSE on
  /// non-web platforms AND on iOS Safari, which has no working document
  /// fullscreen (calling `requestFullscreen` is a no-op there) — so the button
  /// is simply hidden rather than showing a dead toggle.
